...
<table width="100%" border="1">
  <tr>
    <td bgcolor="#FFFF33" id="JD">PROJECT NANOHACK</td>
  </tr>
</table>
...
<tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr> <tr>
        ...
        <td align="center" valign="middle"><form name="form1" method="post" action="">
      <label>
        <button id="o"  type="button" onclick="buttonclick(this);" class="button yellow"></button> 
      </label>
    </form></td>
      <td align="center" valign="middle"><form name="form1" method="post" action="">
&nbsp;
        ...
        <td align="center" valign="middle"><form name="form1" method="post" action="">
      <label>
        <button id="f"  type="button" onclick="buttonclick(this);" class="button yellow"></button> 
      </label>
    </form></td>
  </tr>
  
</table>
<p class="foot">Team NanoHackers</p>
</body>
</html>
)rawliteral";
